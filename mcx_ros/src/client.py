...
class MinimalClientAsync(Node):
    ...
    def __init__(self):
        ...
        self.action_client = ActionClient(self, ExecuteTrajectory, 'execute_laser_trajectory')
    ...
    def send_goal(self):
        ...
        pose3.position.x = 0.159
        pose3.position.y = -0.7
        pose3.position.z = 0.07
        ...
        pose4.position.x = 0.159
        pose4.position.y = -0.5
        pose4.position.z = 0.07



        pose4.orientation.x = x
        pose4.orientation.y = y
        pose4.orientation.z = z
        pose4.orientation.w = w

        
        goal_msg.poses = [pose1, pose2, pose3, pose4]
