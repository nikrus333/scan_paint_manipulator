...
class MinimalClientAsync(Node):
    ...
    def send_request_trajectory(self, req: TrajectoryMode.Request):
    ...
    #     t = self.tf_buffer_1.lookup_transform('world', 'manipulator', rclpy.time.Time(),  timeout=rclpy.duration.Duration(seconds=3.0))
    #     return t
